databaseChangeLog = {
    ...
    changeSet(author: "sarah (generated)", id: "1462249427193-1") {
    ...
    changeSet(author: "sarah (generated)", id: "1462249427193-2") {
        addColumn(tableName: "quote") {
            column(name: "attribution_id", type: "bigint")
        }
    }

    changeSet(author: "sarah (generated)", id: "1462249427193-3") {
